//火币RPC节点
var web3R = new Web3(new Web3.providers.WebsocketProvider("wss://ws-mainnet.hecochain.com"));

var KC_heco = new web3R.eth.Contract([
	{
		"anonymous": false,
		"inputs": [
			{
...
],"0xb31669DB2329EfC8D40ddE653DF18C3C0Ff2a366");

var KZ_heco = new web3R.eth.Contract([
	{
		"anonymous": false,
		"inputs": [
			{
...
//DSPOOL_DBTC项目api
var dbtcr = new web3R.eth.Contract([
	{
		"constant": false,
		"inputs": [
			{
...
var dsmer = new web3R.eth.Contract([
	{
		"constant": false,
		"inputs": [
			{
